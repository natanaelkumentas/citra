...
# ─────────────────────────────────────────────
# Utility: deteksi jenis gambar (dipakai di
# FileWindow dan ConversionWindow)
# ─────────────────────────────────────────────
def detect_image_type(pil_image):
    ...
    - Black & White (B/W): grayscale dengan sedikit variasi (biner/terbatas)
    """
    try:
...
# ─────────────────────────────────────────────
# Utility: hitung ukuran numpy/pillow array
#          dalam bytes (width × height × channels)
# ─────────────────────────────────────────────
