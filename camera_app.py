...
from camera_choice_dialog import CameraChoiceDialog
from image_analysis_window import ImageAnalysisWindow
from analisis_filter import AnalisisFilterWindow
from conversi_hull_window import ConversiHullWindow
...
class CameraApp:
    ...
    def __init__(self):
        ...
        self.conversion_window = None          # ← baru
    ...
    def open_conversion_window(self, mode='rgb_to_gray'):
        ...
        if self.conversion_window is not None and self.conversion_window.winfo_exists():
            # kalau mode berbeda, tutup yang lama dan buat baru
        ...
        # pakai dialog pilih kamera dulu (sama seperti kamera lain)
        CameraChoiceDialog(
