...
from core.config import SUPABASE_TABLE_IMAGE_STATS
from services import camera_service, supabase_service
...
class ImageAnalysisWindow(tk.Toplevel):
    ...
    def save_to_supabase(self):
        ...
        try:
            rows = supabase_service.insert_record(SUPABASE_TABLE_IMAGE_STATS, payload, prefer_return=True)
    ...
    def export_to_excel(self):
        try:
            rows = supabase_service.fetch_records(
                SUPABASE_TABLE_IMAGE_STATS,
